  $(function(){
    ...
    var swiper = new Swiper(".mySwiper", {
      ...
      var swiper = new Swiper(".panel2_swiper", {
        ...
        navigation: {
          nextEl: ".panel2_swiper .swiper-button-next",
          prevEl: ".panel2_swiper .swiper-button-prev",
        },
      });

      var swiper = new Swiper(".panel4_swiper", {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: true,
        pagination: {
        ...
        navigation: {
          nextEl: ".panel4_swiper .swiper-button-next",
          prevEl: ".panel4_swiper .swiper-button-prev",
        },
      });
